defmodule Craftplan.Accounts.User.Changes.Register do
  @moduledoc false
  ...
  def change(changeset, _opts, context) do
    Ash.Changeset.after_action(changeset, fn _changeset, user ->
      ...
      with {:ok, org} <-
             Ash.create(Craftplan.Accounts.Organization, params,
               action: :create,
               authorize?: false
             ),
           {:ok, _membership} <-
        ...
        Ash.update(user, %{organization_id: org.id}, authorize?: false)
      end
