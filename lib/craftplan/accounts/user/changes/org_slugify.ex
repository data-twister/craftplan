defmodule Craftplan.Accounts.User.Changes.OrgSlugify do
  @moduledoc false
  ...
  def change(changeset, _opts, context) do
    if changeset.action_type == :create do
      Ash.Changeset.force_change_attribute(changeset, :prefix, generate_slug(changeset, context))
    else
      changeset
    end
  end
